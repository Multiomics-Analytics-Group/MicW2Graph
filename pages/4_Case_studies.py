...
st.markdown(
    "<h3 style='text-align: center; color: black;'>Case studies based on an association and functional clusters</h3>",
    unsafe_allow_html=True,
)
...
with col2:
    ...
    try:
        ...
        G = web_utils.load_and_preprocess_kg(
            case_study_graphml, color_nodes, edge_colors, min_size=8, max_size=24
        )
    except:
        st.warning(
