...
st.markdown("<h3 style='text-align: center; color: black;'>Microbial association networks by wastewater treatment sub-biome and experiment types</h3>", unsafe_allow_html=True)
...
with col2:
    ...
    try: 
        ...
        microbial_asso_net_path = st.session_state.config['microbial_asso_nets'][sub_biome][exp_type]
        ...
        st.warning("The network is not available. Please select another sub-biome and experiment type.", icon="⚠️")
        st.stop()
